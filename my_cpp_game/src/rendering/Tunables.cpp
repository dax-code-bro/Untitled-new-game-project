...
#define I(name, expr) {name, Slot{nullptr, nullptr, [](Renderer& r) { return &(expr); }}}
    static const std::map<std::string, Slot> m = {
        ...
        F("envIntensity", r.envIntensity), F("bevelScale", r.bevelScale), F("weatheringScale", r.weatheringScale), F("wetScale", r.wetScale), F("detailScale", r.detailScale), F("detailFade", r.detailFade),
