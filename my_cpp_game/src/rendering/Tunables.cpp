...
#define I(name, expr) {name, Slot{nullptr, nullptr, [](Renderer& r) { return &(expr); }}}
    static const std::map<std::string, Slot> m = {
        ...
        F("post.grain", r.post.grain), F("post.autoKey", r.post.autoKey), F("post.autoMin", r.post.autoMin),
        F("post.autoMax", r.post.autoMax), F("post.autoSpeed", r.post.autoSpeed), V("post.tint", r.post.tint), F("post.tintMix", r.post.tintMix),
        ...
        F("envIntensity", r.envIntensity), F("bevelScale", r.bevelScale), F("weatheringScale", r.weatheringScale), F("wetScale", r.wetScale), F("interiorScale", r.interiorScale), F("detailScale", r.detailScale), F("detailFade", r.detailFade),
