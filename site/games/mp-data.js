...
(function () {
  ...
  var GUNS = [
    ...
    { id: 'garand', name: 'M1 Garand', cls: 'assault', fam: 'garand',
      ...
      ads: 0.28, move: 0.94, reload: 2.2, rec: [0.95, 0.34], spread: 2.4, mv: 853,
    ...
    { id: 'svt40', name: 'SVT-40', cls: 'assault', fam: 'garand',
      ...
      ads: 0.26, move: 0.95, reload: 2.4, rec: [0.84, 0.30], spread: 2.5, mv: 830,
    ...
    { id: 'remington', name: 'Remington 700', cls: 'special', fam: 'bolt',
      ...
      ads: 0.42, move: 0.88, reload: 3.2, rec: [2.2, 0.5], spread: 6.0, mv: 820,
      oneShot: 'chest',
    ...
    { id: 'kar98', name: 'Kar98k', cls: 'special', fam: 'bolt',
      ...
      ads: 0.45, move: 0.89, reload: 3.6, rec: [2.4, 0.5], spread: 6.4, mv: 760,
      oneShot: 'chest',
    ...
    { id: 'mosin', name: 'Mosin-Nagant', cls: 'special', fam: 'bolt',
      ...
      ads: 0.47, move: 0.88, reload: 3.8, rec: [2.5, 0.6], spread: 6.6, mv: 800,
      oneShot: 'chest',
    ...
    { id: 'killstreak', name: 'The Kill Streak', cls: 'special', fam: 'amr',
      ...
      ads: 0.58, move: 0.76, reload: 4.4, rec: [4.0, 0.9], spread: 8.0, mv: 880,
    ...
    { id: 'barrett', name: 'Barrett M82', cls: 'special', fam: 'amr',
      ...
      ads: 0.62, move: 0.74, reload: 4.8, rec: [3.6, 1.0], spread: 8.4, mv: 853,
    ...
    { id: 'scatter', name: 'Scattergun', cls: 'special', fam: 'pump',
      ...
      ads: 0.30, move: 0.96, reload: 0.55, reloadKind: 'shell', rec: [1.6, 0.5], spread: 6.5, mv: 380,
    ...
    { id: 'sawnoff', name: 'Sawn-Off', cls: 'special', fam: 'pump',
      ...
      ads: 0.22, move: 1.05, reload: 2.1, rec: [2.4, 1.1], spread: 10.0, mv: 350,
    ...
    { id: 'webley', name: 'Webley Mk VI', cls: 'pistol', fam: 'handcannon',
      ...
      ads: 0.20, move: 1.02, reload: 2.6, reloadKind: 'moon', rec: [1.7, 0.6], spread: 3.8, mv: 200,
    ...
    { id: 'panzer', name: 'Panzerfaust', cls: 'launcher', fam: 'tube',
      ...
      ads: 0.50, move: 0.88, reload: 3.6, rec: [3.0, 0.6], spread: 1.0, mv: 60,
    ...
    { id: 'bazooka', name: 'M1 Bazooka', cls: 'launcher', fam: 'tube',
      ...
      ads: 0.52, move: 0.86, reload: 4.0, rec: [2.6, 0.5], spread: 1.2, mv: 82,
      splash: 4.2,
    ...
    { id: 'rpg7', name: 'RPG-7', cls: 'launcher', fam: 'tube',
      ...
      ads: 0.50, move: 0.87, reload: 3.8, rec: [2.8, 0.6], spread: 1.0, mv: 115,
      splash: 5.0,
    ...
    { id: 'stinger', name: 'Stinger FIM', cls: 'launcher', fam: 'guided',
      ...
      ads: 0.60, move: 0.86, reload: 4.2, rec: [1.8, 0.4], spread: 0, mv: 200,
    ...
    { id: 'm79', name: 'M79 Thumper', cls: 'launcher', fam: 'grenade',
      ...
      ads: 0.34, move: 0.95, reload: 2.6, rec: [2.0, 0.5], spread: 1.4, mv: 76,
    ...
    { id: 'gl6', name: 'Six-Shot GL', cls: 'launcher', fam: 'grenade',
      ...
      ads: 0.44, move: 0.88, reload: 6.5, rec: [1.6, 0.6], spread: 2.0, mv: 76,
