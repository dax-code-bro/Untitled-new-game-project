...
═══════════════════════════════════════════════════════════════════════
# ▓▓▓ FILE: missions/mission-18.md ▓▓▓
═══════════════════════════════════════════════════════════════════════

# Mission 18 (title TBD) — The Hunt for Abraham begins / Spike's Dire Hour

> **Canonical script (in progress).** Preserves EVERY detail. Target rating:
> **ESRB M** (escalated-language era; heavy psychological themes).
> **⚠ Title TBD** (naming convention: foreshadow).

## Placement
- Follows the **M17 coda** (the night of peace; morning = "they've got to find
  him"). The hunt for **Abraham** — the last hostile Pillar — begins.

## STATE OF THE WORLD (new canon)
- **HYDRA IS GONE. ALL of it.** With **Victor Prestige dead** (M17), the
  century-old organization is finished — no owner, no factories, no program.
  The war that consumed two generations is *over*, except for one man:
  **General Abraham**, a continent away in Antarctica.
- So the story pivots from **war** to **hunt** — and from external enemies to
  what the war *left behind* inside the survivors.

## SPIKE — SOMETHING DIRE (new canon, the counterweight scene)

> The happy ending belongs to Molotov. It does **not** belong to Spike.

- **Spike is experiencing something dire.** While everyone else goes home,
  Spike has no home to go to. The peace that lets Molotov finally sleep is the
  same silence that leaves Spike alone with the arithmetic of his life:
  - **He lost the people he looked up to.** Fox. Striker. Payback. The twins.
    All of Team Apex — massacred in front of the world he trusted (M11). His
    father Diego's generation, gone; his own generation, gone.
  - **He's practically a FULL CYBORG.** (⚠ MAJOR canon escalation — see below.)
  - **Everything he's ever loved is gone.** Orphaned by 1985 (Diego and his
    mother both dead). His team dead. His body — piece by piece — gone too.
- **The Molotov/Spike mirror (design note):** the two survivors of Team Apex
  got **opposite endings.** Molotov came out of the fire with a wife, a son,
  a family, a home — *more* than he started with. Spike came out with a
  gravity rig, replacement parts, and a list of graves — *less* of himself
  than he started with, in every sense. The night Molotov finally sleeps is
  the night Spike can't. The happy ending and the dire one are **the same
  night, intercut.**

### THE SCENE (⚠ proposed staging — creator gave the state, not the shots)

> *(Same night as the M17 coda. INTERCUT with Molotov falling asleep beside
> Elizabeth:)*
>
> *(**SPIKE**, alone at the renovated HQ. Everyone else has somewhere to be.
> The lights are half off. He sits at Charles's workbench — doing
> **maintenance on his own body.** A panel open. A tool in his hand. The
> routine of a man servicing the machine he lives in.)*
>
> *(He stops. Looks at his hands — how much of them is still *him*. On the
> wall, or in his head: the old team. Fox. Striker. Payback. The people he
> looked up to. Every one of them gone.)*
>
> *(HYDRA is gone. The thing his father survived, the thing he gave his body
> fighting — finished. And the victory did not give him one single thing
> back.)*
>
> *(No dialogue proposed — Spike alone shouldn't talk to anyone. The silence
> IS the scene. Creator to supply any interior beat/voice if wanted.)*

## ⚠ CANON ESCALATION — SPIKE, THE FULL CYBORG
- **Prior canon:** M10 — Molotov stabbed/shot him; paralyzed ("I can't feel my
  legs"). 2000 era — walks via a **gravity stabilizer waist rig**; heavy
  weapons.
- **NEW (this beat):** by now Spike is **practically a full cyborg** — far
  beyond the waist rig. Over the 15 years, more and more of him was replaced.
- **⚠ OPEN — do NOT invent:**
  - **What parts** are machine (legs certain; arms? torso? more?) and what's
    still flesh.
  - **How it happened** — one event, or gradual (the M10 wounds cascading over
    15 years? battle damage since? did the epilogue-era missions cost him
    parts we haven't scripted?).
  - **Who built him** — Charles (the team's gunsmith/tech) is the obvious
    inference; **confirm.**
  - **How he feels about it** — "dire" suggests the cyborg body is part of the
    crisis (everything he loved is gone — *including his own body*).
- **Thematic note (flag, not canon):** Spike fought a **drone war** and slowly
  became **more machine than the drones he fought.** He is now closer kin to
  **Drone 9** — an aging machine wondering what it's for — than to any living
...
═══════════════════════════════════════════════════════════════════════
# ▓▓▓ FILE: campaign-loadout.md ▓▓▓
═══════════════════════════════════════════════════════════════════════

# Campaign Loadout System — The Mission Board

> **Canon (creator-specified), with unlock pacing DELEGATED to the designer**
> (the creator asked me to choose *after which mission* each item unlocks —
> those picks are marked **[D]** and are adjustable on request; the allowed
> item lists themselves are creator canon).

## The System
- **Before every mission**, at the **MISSION BOARD**, the player chooses:
  1. **PRIMARY**
  2. **SECONDARY**
  3. **LETHAL**
  4. **MELEE** *(⚠ "Malay weapon" = melee. The creator has NOT yet listed
     melee options — knife assumed as default; list TBD.)*
- Weapons/attachments **unlock as the campaign progresses** — you don't get
  the full list up front.
- **Mission 1 exception:** **no choice.** You are issued a **standard-issue
  M4 with IRON SIGHTS and a LASER.** (The board doesn't exist yet —
  you're a soldier being handed a rifle.)

## Allowed Weapons (campaign) — creator canon
...
**Primaries — SMGs (exactly 3 — [D] designer's picks from the arsenal):**
- **HK MP5** [D] — the gold-standard 1985 SMG; era-perfect.
- **Uzi** [D] — era-perfect second pick; iconic 80s silhouette.
- **HK UMP45** [D] — deliberately anachronistic for 1985, so it's gated to
  the **2000 era** — the "modern" SMG of the epilogue. *(Also synergizes
  with the .45 ACP ammo unlock.)*

**Primaries — machine guns (exactly 2 — [D] designer's picks):**
> *(⚠ Note: the detailed arsenal doc currently has NO machine-gun class —
> these two picks seed it.)*
- **M60** [D] — the classic US heavy; fits 1985 issue.
- **PKM** [D] — the Eastern counterpart; justified as captured enemy stock
  (same logic as the AK-47) and Hunter-militia surplus in the epilogue.

**Lethals:**
- Frag Grenade
- Sticky Bomb
- Land Mine *(⚠ "land of mine" = land mine)*

## Allowed Attachments (campaign) — creator canon ("heavily restricted")

**Optics (6):**
- Red Dot Sight
- Viper Red Dot Sight
- Cobra DMR Red Dot Sight
- 4X Magnification Scope
- 10X Magnification Scope
- Thermal Scope

**Stocks (3):** *(⚠ parsed from "no stock movement stock stock, recoil
stock" — confirm)*
- No Stock
- Movement Stock
- Recoil Stock

**Lasers (2):** *(⚠ parsed from "steady, aim, laser motion, laser" —
confirm)*
- Steady Aim Laser
- Motion Laser

**Ammunition (4) — for pistols and rifles:** *(⚠ parsed from "discounts for
pistols and rifles the 50.GSD 45 ACP shredder bullets and fast cycle" —
read "different rounds for pistols and rifles"; confirm)*
- **.50 GS** *(⚠ "50.GSD" — recorded as .50 GS; confirm designation)*
- **.45 ACP**
- **Shredder Bullets**
- **Fast Cycle**

## UNLOCK SCHEDULE — [D] designer's pacing (adjustable)

> Logic used: (1) story-justified — you unlock what the story just put in
> your hands; (2) the 1985 arc plays era-authentic, the 2000 arc gets the
> advanced tech; (3) tragedy missions deliberately unlock nothing; (4) the
> endgame opens the whole cabinet.

| After / At | Unlocks | Story justification |
| --- | --- | --- |
| **M1** | *(fixed loadout)* standard-issue **M4** + iron sights + laser | You're handed a rifle. You use the rifle. |
| **M2** | *(board inactive — 1948 flashback, fixed period weapons)* | Diego's war, Diego's guns. |
| **M3** — board debuts | **M4** (choosable), **9mm**, **Frag Grenade**, **Knife** (melee default), **Red Dot**, **Steady Aim Laser** | First real op cycle; standard kit certified. |
| **M4** | **M16**, **Glock 19** | Quartermaster expands standard issue. |
| **M5** | **1911**, **Recoil Stock** | The classic US sidearm enters the armory. |
| **M6 "Hellfire"** | **AK-47**, **Sticky Bomb** | Full-team battle → captured enemy stock enters circulation. |
| **M7 "Industry"** | **MP5**, **Uzi**, **No Stock**, **Movement Stock** | Casino infiltration = CQB era begins; compact weapons certified. |
| **M8** | *(board inactive — flashback)* | Molotov's past has no loadout. |
| **M9 "The Reboot"** | **DMR**, **Cobra DMR Red Dot**, **4X Scope** | Precision doctrine after the intel war escalates. |
| **M10** | **M60**, **Land Mine**, **Motion Laser** | The war turns heavy; area denial and sustained fire. |
| **M11** | **10X Magnification Scope** | The overwatch hill. *(Dark note: the mission that made snipers matter.)* |
| **M12** | **— nothing —** *(deliberate)* | Molotov finds the bodies. The board unlocks nothing; the game doesn't reward this day. |
| **M13** | *(board LOCKED — degraded fixed gear)* | Poverty canon: DM10 hitting like an AK, blurry sights. You use what hasn't rusted. |
| **M14** | *(board returns, renovated)* **UMP45**, **.45 ACP rounds** | Charles's workshop comes online — the modern era of the armory. |
| **M15** | **Thermal Scope** | Drone-hunting in dark tunnels; you never go into a blood tunnel blind again. |
| **M16** | **.357 Magnum**, **.50 GS rounds** | After the parley: Hunter's caliber culture rubs off. Big-bore era. |
| **M17** | **PKM**, **Shredder Bullets** | Hunter's militia surplus + anti-drone rounds (born of the drone-shrapnel idea). |
| **M18** | **Fast Cycle rounds** | Charles refines the ammo bench while the team regroups. |
| **M19–M20** | **EVERYTHING** — full allowed list open | The endgame. The cabinet is open. *(Mission-specific kit — M19 stealth pistol/rocks/bribes — overrides the board as scripted.)* |

## NOTES / FLAGS
- **⚠ MELEE LIST NOT GIVEN** — the board has a melee slot, but the creator
  hasn't listed melee weapons yet. Knife assumed as the M3 default. Awaiting
  the list.
- **⚠ "9mm"** recorded as its own pistol (as stated). Note the resonance:
  an ash-covered **9mm** is the gun that kills Abraham in M20. The player's
  humble starter pistol class is the campaign's final weapon. *(Coincidence
  or intent — either way it's good.)*
- **⚠ The DMR** on the board is presumably the **DM10 family** (the M13
  degraded gun) — confirm which DMR model the campaign board offers.
- **⚠ Ammo scope:** ammunition types listed "for pistols and rifles" — read
  as ammo applying to both classes (not SMGs/MGs). Confirm.
- **Attachment restriction philosophy (recorded):** campaign attachments are
  **heavily restricted** vs. multiplayer's full attachment system (see
  arsenal.md) — the campaign board is a curated subset, not the MP
  gunsmith.
- **[D] items are delegated picks** — SMG trio (MP5/Uzi/UMP45), MG pair
  (M60/PKM), and every unlock placement. Say the word and any of them move.

## ⚠ DICTATION / GARBLES LOGGED
- "**Malay weapon**" → **melee weapon.**
- "9 mm **for a rifles**" → "9mm. **For rifles**, …"
- "**land of mine**" → **land mine.**
- "**the cobra DMR red dot site the red dot site the viper red dot site**" →
  three distinct optics: Cobra DMR Red Dot, Red Dot, Viper Red Dot.
- "**no stock movement stock stock, recoil stock**" → No Stock, Movement
  Stock, Recoil Stock.
- "**steady, aim, laser motion, laser**" → Steady Aim Laser, Motion Laser.
- "**discounts** for pistols and rifles" → read as "**different rounds** for
  pistols and rifles." **Confirm.**
- "**the 50.GSD**" → recorded as **.50 GS** rounds. **Confirm designation.**


═══════════════════════════════════════════════════════════════════════
# ▓▓▓ FILE: operator-gear.md ▓▓▓
═══════════════════════════════════════════════════════════════════════
...
# Hideouts — The Campaign's Explorable Hubs

> **Canon (creator-specified).** The player passes through **THREE different
> hideouts over the main story** — living hub spaces between missions (home
> of the mission board, the crew, and ambient life).

## Hideout 1 — THE MILITARY BASE (1985 era)

> **The BIGGEST hideout in the game.**

### Facilities
- **Five barracks**
- A **super big restroom**
- **Several office buildings**
- A **cafeteria**
- **The garage** — frequently being worked on (mechanics always at it)
- **The missions area** — where **the rest of the crew hangs out** (and
  presumably the mission board lives — confirm)
- **Planes** on-site (flight line), with people inspecting/checking them out
- **Ammunition & gun-building stations** — you can watch armorers building
  ammo and weapons

### Population (headcount canon)
| Who | Count |
| --- | --- |
| Pilots walking around | **~20** |
| Security guards | **10** |
| Military operators | **20** |
| Generals | **10** |
| **The President** | **1** |
| The crew (Team Apex) | in the missions area |

### Ambient life
- **Pilots, security guards, etc. wander the base talking about the most
  random stuff** — overhearable chatter everywhere.
- **Unique voice lines if you TALK to them** — NPCs are directly
  interactable, not just scenery.
- Visible activity: people **checking out stuff on planes**, **building
  ammunition and guns**, working the garage.

### Random interactions (20)
- **~20 different random interactions** can be found around the base —
  e.g., **a few operators getting into trouble**, "and a few other things."
- ⚠ Only the "operators getting into trouble" example was specified; the
  other ~19 interactions are **open** — creator to supply, or delegable
  (say the word and I'll draft the list).

### THE PRESIDENT — RULED (creator)
- The base's "1 President" is **the president of the CAMPUS** — the base's
  own civilian head (an administrative "president of the entire campus"),
  **NOT the national President.**
- **Distinct from PRESIDENT JAMES** — *(NEW CANON, named here)* — **the
  President in "Hellfire" (M6)**: the one who took Abraham's emergency
  line, ordered the Hellfire strike over his objection, and was extracted
  by the team. Previously unnamed in the M6 script; now canonically
  **President James.** (Cross-reference updated in mission-06.md.)

### Random interactions — the full 20 [D]
> #1 is the creator's; #2–#20 are **[D] delegated designs** (adjustable).
1. A few **operators getting into trouble** *(creator's example)*.
2. Two pilots arguing over whose landing was worse; a third quietly rates
   them both.
3. A security guard asleep standing up — and the sergeant creeping toward
   him with an air horn.
4. A cafeteria-wide debate about what the mystery meat actually is,
   escalating toward a food fight that never quite starts.
5. An armorer test-fires something WAY too big indoors. Once. (The
   super-big restroom is next door; both doors open at the same moment.)
6. A lost recruit asking everyone for directions to the barracks and being
   given four different wrong answers.
7. The eternal poker game in Barracks 3 — broken up by MPs every time you
   pass, reassembled by the next.
8. A mechanic under a jeep in the garage having a full argument WITH the
   jeep. The jeep appears to be winning.
9. Two generals disagreeing with terrifying politeness while their aides
   sweat through their uniforms.
10. A private selling contraband snacks out of a footlocker with a full
    menu and loyalty program.
11. A pilot who has named his plane and talks to it during inspection —
    gets defensive if you comment.
12. A conversation that stops DEAD when **Payback** walks past; nobody
    resumes it until she's gone. (Nobody knows her name. Nobody asks.)
13. The **Wolford twins** getting mistaken for each other — Brian doesn't
    bother correcting it; Jesse corrects it loudly, twice.
14. **Fox** retelling an old war story near the cafeteria; the numbers get
    bigger every time you overhear it.
15. **Striker** doing pull-ups while two operators dispute his count on
    principle.
16. Two recruits daring each other to go talk to **Molotov**, who is
    standing perfectly still by the flight line. Neither ever does.
17. A base dog that everyone feeds and no one owns; its name is different
    depending on who you ask.
18. The **campus president** doing an inspection walk — every NPC in view
    becomes intensely, unconvincingly busy.
19. An office-building radio war: one song on repeat, and a rotating cast
    of victims trying to change the station.
20. Someone repainting the base sign after "an incident" no one will
    explain. The paint never quite matches.
*(Replay pathos, intended: half these interactions feature people who die
in M7/M11. The base is funny the first time and a memorial the second.)*

### Flags
- **⚠ Abraham among the 10 generals?** He's THE general attached to the
  team — presumably walks this base pre-M11. Dramatic-irony gold on
  replay. Confirm.
- **Era/tenure:** the **1985 hub** (M1–M12 era).

## Hideout 2 — THE LITTLE MANSION (2000 era) [D details]

> **Creator canon:** the second hideout is **a little mansion.** Details
> below are **[D] delegated designs** (adjustable). Reconciled with story
> canon: this IS the 2000-era HQ — the poor hideout of M13 that gets
> **renovated in M14.**

- **The place:** a small, once-grand mansion — somebody's abandoned estate
  the new team squatted and made theirs. Two floors, a dozen rooms, a
  walled yard gone wild.
- **M13 state (poverty era):** boarded windows, one working faucet, buckets
  under the leaks, furniture burned for heat one bad winter, the chandelier
  sold. Gear degrades because the armory is a damp closet (ties to the
  canon gear-degradation mechanic).
- **M14 state (renovated):** the renovation montage made real — windows
  glazed, generator humming, **Charles's workshop** in the old ballroom
  (gun benches where the dance floor was), the **mission board in the
  dining room** on the wall where a family portrait used to hang.
- **Population:** small and family-shaped — the team (Molotov, Spike,
  Jonah, Nova, Atomic, Jeff, Charles), **Elizabeth** sometimes, nobody
  else. After the base's ~61 NPCs, the emptiness is the point: this era's
  war has seven people and a kid.
- **Random interactions [D] (~10):** Jonah's bottle-target range off the
  back porch (and Molotov silently moving the bottles further each week);
  Atomic bench-pressing the surviving furniture; Charles's bench with a
  "DO NOT TOUCH" sign in five languages; Jeff's door — always closed,
  light always on, never seen entering or leaving; Nova cooking something
  cartel-spiced that makes Spike cry (he claims it's the onions); the
  leak-bucket in the hall everyone steps around like a housemate; the
  team's mismatched mugs, each with a story nobody finishes; a wall where
  someone pencil-marks Jonah's height and someone taller keeps adding
  inches to the top mark as a joke; movie night around one salvaged TV
  with three working channels; Elizabeth's coat hook — sacred, unused for
  weeks at a stretch, and the first thing everyone glances at when they
  come in.
- **Credits note (careful):** the campaign's credits pick Elizabeth up at
  "the mansion" — presumably THIS mansion. *(This identifies the building
  only. 🔒 Sealed question #1 — how/whether Elizabeth got there from
  Antarctica — remains permanently unanswered, per the creator's ruling.)*

## Hideout 3 — THE LITTLE CABIN IN ANTARCTICA (endgame) [D details]

> **Creator canon:** the last hideout is **a little cabin in Antarctica** —
> the M19 "temporary safe house." Details below are **[D] delegated
> designs** (adjustable).

- **The place:** one room and a gear corner. Bunks for five stacked too
  close, a stove nobody needs anymore, frost-proofing on the windows —
  built for the Antarctica that no longer exists. **Outside it's 87° and
  green; inside, a cabin engineered for −40 slowly cooking its occupants.**
  Everyone props the door.
- **The mission board** is a tablet on an ammo crate (the M20 analysis
  tablet — same one).
- **Phase 1 (the expedition):** five men, one secret extra (Hunter beds
  down outside on his own bedroll — walls, he says, are how you get
  cornered), gear stacked to the ceiling, planning by lamplight.
- **Phase 2 (everyone came):** after the family's arrival the cabin is
  hopeless — Elizabeth and Jonah get the bunks, the militia raises a tent
  city in the meadow around it, Martin & Lewis run a quartermaster line
  off folding tables, and the little cabin becomes the war's smallest
  capital: one lamp, one map, thirty tents.
- **Random interactions [D] (~8):** freed prisoners learning rifle drills
  from Jeff (patient) and Atomic (loud); Martin & Lewis inventorying the
  "mountain" of rifles and arguing over the count; a militia man who keeps
  saluting Jonah because the mask looks like rank; someone trying to grow
  a vegetable in Antarctic soil because it's 87° now, why not; Hunter's
  bedroll spot — nobody uses it even when he's away; the sweating-cabin
  joke ("coldest continent on Earth" as everyone fans themselves); a
  nightly map argument about the mountain trail; and Elizabeth and
  Molotov's quiet minute on the porch at sundown that every other
  interaction politely routes around.

## ⚠ DICTATION / GARBLES LOGGED

## ⚠ DICTATION / GARBLES LOGGED
- "20 military operators **10 generals one president**" → recorded as
  headcounts: 20 operators, 10 generals, 1 President.
- "along with **20 different. Random interactions**" → **20 different
  random interactions.**
