...
| 6 | Steyr AUG A3 | Medium | High | High | Medium (~680–750 RPM) | Low-Mid | Semi / Auto | Bullpup; full barrel in compact frame; Picatinny rail replaces original integral optic; slight diagonal pull during sustained fire. |
...
| 14 | AKM | High | Medium-Low | Medium | Medium (~600 RPM) | High | Semi / Auto | Lighter stamped receiver than AK-47; marginally easier to control; same heavy-hitting 7.62×39mm punch. |
...
| 17 | AN-94 | Medium | Elite (first 2 shots) / Medium (auto) | Medium-Low | 1800 RPM (first 2 shots) → Medium (sustained) | Very Low (first 2) / Mid (auto) | Semi / 2-Round Hyperburst / Auto | First two rounds fire at 1800 RPM and land on the same point before recoil kicks in; complex internals add slight weight penalty to handling. |
| 18 | Galil AR | Medium | High | Medium-Low | Medium-High | Low | Semi / Auto | Heavy rugged steel receiver; physical weight acts as a natural stabilizer; full-auto spray stays exceptionally tight. |
...
| 20 | FAMAS F1 | Medium | Medium | High | Extreme (~950–1000 RPM) | High | Semi / Auto | Fastest cyclic rate in class; compact frame; severe rapid vertical climb from sheer volume of fire. |
...
| 22 | IWI Tavor X95 | Medium | Medium-High | Extreme | Medium-High | Mid | Semi / Auto | Near-SMG handling and draw speed; snappy vertical pop requires active correction; full AR damage in miniature frame. |
...
| 24 | FN F2000 | Medium | High | High | High (~850 RPM) | Low | Semi / Auto | Smooth rounded ergonomic frame; fluid predictable vertical pattern; minimal horizontal drift. |
| 25 | QBZ-95 | Medium-High | High | High | Medium | Low | Semi / Auto | Unique intermediate round with strong armor-defeating traits; compact bullpup; smooth linear recoil. |
| 26 | QBZ-191 | Medium-High | High | Medium-High | Medium-High | Low | Semi / Auto | Modern conventional layout; fast reload speeds; consistent vertical recovery; retains energy at distance. |
| 27 | VHS-2 | Medium | High | High | High | Very Low | Semi / Auto | Incredibly flat, consistent continuous fire line; sleek chassis; rapid target acquisition. |
...
| 29 | Beretta ARX-160 | Medium | Medium-High | High | Medium-High | Mid | Semi / Auto | Advanced technopolymer build; very lightweight; slight snappy jump on initial shots. |
