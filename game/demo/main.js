...
function normalFromHeight(heightPainter, size = 256, strength = 2.2, rx = 1, ry = 1) {
  const c = document.createElement('canvas'); c.width = c.height = size;
  const x = c.getContext('2d');
  heightPainter(x, size);
...
const BUILD = 16;   // bump with each demo update — shown on the badge so staleness is visible
