...
function wallTexture(base, trim) {
  return canvasTex(512, (ctx, s) => {
    ...
    for (let i = 0; i < 9000; i++) {         // stucco noise
...
const BUILD = 17;   // bump with each demo update — shown on the badge so staleness is visible
