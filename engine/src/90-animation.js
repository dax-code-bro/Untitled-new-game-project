...
function makeHumanoidClips() {
  ...
  clips.push(buildClip('walk', 0.9, {
    hips: {
      ...
      pos: [[0.00, 0, -0.048, 0], [0.06, 0.004, -0.057, 0], [0.13, 0.009, -0.054, 0],
                 [0.19, 0.013, -0.041, 0], [0.25, 0.018, -0.025, 0], [0.31, 0.013, -0.016, 0],
                 [0.38, 0.009, -0.019, 0], [0.44, 0.005, -0.033, 0], [0.50, 0, -0.048, 0],
                 [0.56, -0.004, -0.057, 0], [0.63, -0.009, -0.054, 0], [0.69, -0.013, -0.041, 0],
                 [0.75, -0.018, -0.025, 0], [0.81, -0.013, -0.016, 0], [0.88, -0.009, -0.019, 0],
                 [0.94, -0.005, -0.033, 0], [1.00, 0, -0.048, 0]],
    },
    ...
    upperLegL: { keys: [[0.00, -32.5, 0, 0], [0.05, -34.9, 0, 0], [0.10, -34.6, 0, 0], [0.15, -31.8, 0, 0],
             [0.20, -27.2, 0, 0], [0.25, -21.7, 0, 0], [0.30, -16.5, 0, 0], [0.35, -12.5, 0, 0],
             [0.40, -11, 0, 0], [0.45, -10.3, 0, 0], [0.50, -8.7, 0, 0], [0.55, -6.8, 0, 0],
             [0.60, -3.5, 0, 0], [0.65, -5.9, 0, 0], [0.70, -15.6, 0, 0], [0.75, -27.7, 0, 0],
             [0.80, -37.7, 0, 0], [0.85, -39.7, 0, 0], [0.90, -38.5, 0, 0], [0.95, -35.6, 0, 0],
             [1.00, -32.5, 0, 0]] },
    lowerLegL: { keys: [[0.00, 17.1, 0, 0], [0.05, 28.7, 0, 0], [0.10, 35.1, 0, 0], [0.15, 36.8, 0, 0],
             [0.20, 34.9, 0, 0], [0.25, 31.1, 0, 0], [0.30, 27.7, 0, 0], [0.35, 26.6, 0, 0],
             [0.40, 30.9, 0, 0], [0.45, 37.1, 0, 0], [0.50, 41.6, 0, 0], [0.55, 45.2, 0, 0],
             [0.60, 45.1, 0, 0], [0.65, 53, 0, 0], [0.70, 65.2, 0, 0], [0.75, 72.7, 0, 0],
             [0.80, 70.1, 0, 0], [0.85, 53.5, 0, 0], [0.90, 35.9, 0, 0], [0.95, 21.9, 0, 0],
             [1.00, 17.1, 0, 0]] },
    footL: { keys: [[0.00, 3.5, 0, 0], [0.05, 0.9, 0, 0], [0.10, -4.1, 0, 0], [0.15, -8.2, 0, 0],
             [0.20, -10.4, 0, 0], [0.25, -11.6, 0, 0], [0.30, -12.9, 0, 0], [0.35, -15.4, 0, 0],
             [0.40, -18.4, 0, 0], [0.45, -20.7, 0, 0], [0.50, -21.6, 0, 0], [0.55, -18.7, 0, 0],
             [0.60, -13.7, 0, 0], [0.65, -5.3, 0, 0], [0.70, -4, 0, 0], [0.75, -6.1, 0, 0],
             [0.80, -8.3, 0, 0], [0.85, -10.1, 0, 0], [0.90, -10.7, 0, 0], [0.95, -8.1, 0, 0],
             [1.00, 3.5, 0, 0]] },
    upperLegR: { keys: [[0.00, -8.7, 0, 0], [0.05, -6.8, 0, 0], [0.10, -3.5, 0, 0], [0.15, -5.9, 0, 0],
             [0.20, -15.6, 0, 0], [0.25, -27.7, 0, 0], [0.30, -37.7, 0, 0], [0.35, -39.7, 0, 0],
             [0.40, -38.5, 0, 0], [0.45, -35.6, 0, 0], [0.50, -32.5, 0, 0], [0.55, -34.9, 0, 0],
             [0.60, -34.6, 0, 0], [0.65, -31.8, 0, 0], [0.70, -27.2, 0, 0], [0.75, -21.7, 0, 0],
             [0.80, -16.5, 0, 0], [0.85, -12.5, 0, 0], [0.90, -11, 0, 0], [0.95, -10.3, 0, 0],
             [1.00, -8.7, 0, 0]] },
    lowerLegR: { keys: [[0.00, 41.6, 0, 0], [0.05, 45.2, 0, 0], [0.10, 45.1, 0, 0], [0.15, 53, 0, 0],
             [0.20, 65.2, 0, 0], [0.25, 72.7, 0, 0], [0.30, 70.1, 0, 0], [0.35, 53.5, 0, 0],
             [0.40, 35.9, 0, 0], [0.45, 21.9, 0, 0], [0.50, 17.1, 0, 0], [0.55, 28.7, 0, 0],
             [0.60, 35.1, 0, 0], [0.65, 36.8, 0, 0], [0.70, 34.9, 0, 0], [0.75, 31.1, 0, 0],
             [0.80, 27.7, 0, 0], [0.85, 26.6, 0, 0], [0.90, 30.9, 0, 0], [0.95, 37.1, 0, 0],
             [1.00, 41.6, 0, 0]] },
    footR: { keys: [[0.00, -21.6, 0, 0], [0.05, -18.7, 0, 0], [0.10, -13.7, 0, 0], [0.15, -5.3, 0, 0],
             [0.20, -4, 0, 0], [0.25, -6.1, 0, 0], [0.30, -8.3, 0, 0], [0.35, -10.1, 0, 0],
             [0.40, -10.7, 0, 0], [0.45, -8.1, 0, 0], [0.50, 3.5, 0, 0], [0.55, 0.9, 0, 0],
             [0.60, -4.1, 0, 0], [0.65, -8.2, 0, 0], [0.70, -10.4, 0, 0], [0.75, -11.6, 0, 0],
             [0.80, -12.9, 0, 0], [0.85, -15.4, 0, 0], [0.90, -18.4, 0, 0], [0.95, -20.7, 0, 0],
             [1.00, -21.6, 0, 0]] },
  ...
  clips.push(buildClip('run', 0.7, {
    hips: {
      keys: [[0.00, 9, -6.5, 0], [0.06, 9, -4.9, 1], [0.13, 9, -3.3, 2], [0.19, 9, -1.6, 3],
                 ...
                 [1.00, 9, -6.5, 0]],
      pos: [[0.00, 0, -0.096, 0], [0.06, 0.003, -0.075, 0], [0.13, 0.006, -0.06, 0],
                 [0.19, 0.01, -0.059, 0], [0.25, 0.013, -0.074, 0], [0.31, 0.01, -0.095, 0],
                 [0.38, 0.006, -0.111, 0], [0.44, 0.003, -0.111, 0], [0.50, 0, -0.096, 0],
                 [0.56, -0.003, -0.075, 0], [0.63, -0.006, -0.06, 0], [0.69, -0.01, -0.059, 0],
                 [0.75, -0.013, -0.074, 0], [0.81, -0.01, -0.095, 0], [0.88, -0.006, -0.111, 0],
                 [0.94, -0.003, -0.111, 0], [1.00, 0, -0.096, 0]],
    },
    ...
    upperLegL: { keys: [[0.00, -49, 0, 0], [0.05, -41.4, 0, 0], [0.10, -32.7, 0, 0], [0.15, -25.5, 0, 0],
             [0.20, -19.6, 0, 0], [0.25, -13.2, 0, 0], [0.30, -5.1, 0, 0], [0.35, 4.2, 0, 0],
             [0.40, 16.4, 0, 0], [0.45, 22.7, 0, 0], [0.50, 15.2, 0, 0], [0.55, 4.5, 0, 0],
    ...
    lowerLegL: { keys: [[0.00, 51.6, 0, 0], [0.05, 50.5, 0, 0], [0.10, 46.7, 0, 0], [0.15, 45.9, 0, 0],
             ...
             [0.40, 25.8, 0, 0], [0.45, 22.9, 0, 0], [0.50, 42.9, 0, 0], [0.55, 62.2, 0, 0],
    ...
    footL: { keys: [[0.00, -7.5, 0, 0], [0.05, -16.1, 0, 0], [0.10, -22.7, 0, 0], [0.15, -25, 0, 0],
             ...
             [0.80, -14.5, 0, 0], [0.85, -14.9, 0, 0], [0.90, -15.3, 0, 0], [0.95, -11.7, 0, 0],
             [1.00, -7.5, 0, 0]] },
    upperLegR: { keys: [[0.00, 15.2, 0, 0], [0.05, 4.5, 0, 0], [0.10, -8.9, 0, 0], [0.15, -24.5, 0, 0],
             [0.20, -40.8, 0, 0], [0.25, -54.1, 0, 0], [0.30, -60.8, 0, 0], [0.35, -60.4, 0, 0],
             [0.40, -57.5, 0, 0], [0.45, -53.4, 0, 0], [0.50, -49, 0, 0], [0.55, -41.4, 0, 0],
             [0.60, -32.7, 0, 0], [0.65, -25.5, 0, 0], [0.70, -19.6, 0, 0], [0.75, -13.2, 0, 0],
             [0.80, -5.1, 0, 0], [0.85, 4.2, 0, 0], [0.90, 16.4, 0, 0], [0.95, 22.7, 0, 0],
             [1.00, 15.2, 0, 0]] },
    lowerLegR: { keys: [[0.00, 42.9, 0, 0], [0.05, 62.2, 0, 0], [0.10, 79.6, 0, 0], [0.15, 93.2, 0, 0],
  ...
  clips.push(buildClip('sprint', 0.5, {
    hips: {
      ...
      pos: [[0.00, 0, -0.061, 0], [0.06, 0.002, -0.052, 0], [0.13, 0.004, -0.066, 0],
                 [0.19, 0.007, -0.093, 0], [0.25, 0.009, -0.119, 0], [0.31, 0.007, -0.128, 0],
                 [0.38, 0.004, -0.114, 0], [0.44, 0.002, -0.087, 0], [0.50, 0, -0.061, 0],
                 [0.56, -0.002, -0.052, 0], [0.63, -0.004, -0.066, 0], [0.69, -0.007, -0.093, 0],
                 [0.75, -0.009, -0.119, 0], [0.81, -0.007, -0.128, 0], [0.88, -0.004, -0.114, 0],
                 [0.94, -0.002, -0.087, 0], [1.00, 0, -0.061, 0]],
    },
    ...
    upperLegL: { keys: [[0.00, -51.9, 0, 0], [0.05, -41.9, 0, 0], [0.10, -31.7, 0, 0], [0.15, -25.1, 0, 0],
    ...
    upperLegR: { keys: [[0.00, 8.3, 0, 0], [0.05, -5.2, 0, 0], [0.10, -23.1, 0, 0], [0.15, -45.5, 0, 0],
             ...
             [0.60, -31.7, 0, 0], [0.65, -25.1, 0, 0], [0.70, -14.8, 0, 0], [0.75, -0.8, 0, 0],
  ...
  clips.push(buildClip('crouchWalk', 1.1, {
    hips: {
      ...
      pos: [[0.00, 0, -0.37, 0], [0.06, 0.005, -0.391, 0], [0.13, 0.01, -0.386, 0],
                 [0.19, 0.015, -0.357, 0], [0.25, 0.02, -0.323, 0], [0.31, 0.015, -0.302, 0],
                 [0.38, 0.01, -0.307, 0], [0.44, 0.005, -0.335, 0], [0.50, 0, -0.37, 0],
                 [0.56, -0.005, -0.391, 0], [0.63, -0.01, -0.386, 0], [0.69, -0.015, -0.357, 0],
                 [0.75, -0.02, -0.323, 0], [0.81, -0.015, -0.302, 0], [0.88, -0.01, -0.307, 0],
                 [0.94, -0.005, -0.335, 0], [1.00, 0, -0.37, 0]],
    },
    ...
    upperLegL: { keys: [[0.00, -115.3, 0, 0], [0.05, -115.8, 0, 0], [0.10, -113.3, 0, 0], [0.15, -107.5, 0, 0],
             ...
             [0.80, -73.1, 0, 0], [0.85, -91.5, 0, 0], [0.90, -100.8, 0, 0], [0.95, -104.8, 0, 0],
             [1.00, -115.3, 0, 0]] },
    ...
    upperLegR: { keys: [[0.00, -61.6, 0, 0], [0.05, -55.2, 0, 0], [0.10, -48.9, 0, 0], [0.15, -42.9, 0, 0],
             ...
             [0.40, -100.8, 0, 0], [0.45, -104.8, 0, 0], [0.50, -115.3, 0, 0], [0.55, -115.8, 0, 0],
             [0.60, -113.3, 0, 0], [0.65, -107.5, 0, 0], [0.70, -99.7, 0, 0], [0.75, -91.6, 0, 0],
             [0.80, -84.5, 0, 0], [0.85, -78.5, 0, 0], [0.90, -73.3, 0, 0], [0.95, -67.9, 0, 0],
             [1.00, -61.6, 0, 0]] },
  ...
  clips.push(buildClip('crouchRun', 0.84, {
    hips: {
      ...
      pos: [[0.00, 0, -0.384, 0], [0.06, 0.004, -0.374, 0], [0.13, 0.007, -0.342, 0],
                 [0.19, 0.011, -0.306, 0], [0.25, 0.015, -0.287, 0], [0.31, 0.011, -0.297, 0],
                 [0.38, 0.007, -0.33, 0], [0.44, 0.004, -0.366, 0], [0.50, 0, -0.384, 0],
                 [0.56, -0.004, -0.374, 0], [0.63, -0.007, -0.342, 0], [0.69, -0.011, -0.306, 0],
                 [0.75, -0.015, -0.287, 0], [0.81, -0.011, -0.297, 0], [0.88, -0.007, -0.33, 0],
                 [0.94, -0.004, -0.366, 0], [1.00, 0, -0.384, 0]],
    },
    ...
    upperLegL: { keys: [[0.00, -119.8, 0, 0], [0.05, -115.8, 0, 0], [0.10, -107.9, 0, 0], [0.15, -97.6, 0, 0],
             ...
             [0.40, -51.5, 0, 0], [0.45, -42.8, 0, 0], [0.50, -33.5, 0, 0], [0.55, -27.4, 0, 0],
             [0.60, -30.4, 0, 0], [0.65, -41.2, 0, 0], [0.70, -60.2, 0, 0], [0.75, -85.1, 0, 0],
             [0.80, -103.2, 0, 0], [0.85, -109.6, 0, 0], [0.90, -110.5, 0, 0], [0.95, -114.2, 0, 0],
             [1.00, -119.8, 0, 0]] },
    lowerLegL: { keys: [[0.00, 110.6, 0, 0], [0.05, 116.9, 0, 0], [0.10, 119.5, 0, 0], [0.15, 118.8, 0, 0],
             ...
             [0.60, 115.8, 0, 0], [0.65, 126, 0, 0], [0.70, 135.5, 0, 0], [0.75, 138.5, 0, 0],
    ...
    footL: { keys: [[0.00, 27.2, 0, 0], [0.05, 19.6, 0, 0], [0.10, 11.9, 0, 0], [0.15, 4, 0, 0],
             ...
             [1.00, 27.2, 0, 0]] },
    upperLegR: { keys: [[0.00, -33.5, 0, 0], [0.05, -27.4, 0, 0], [0.10, -30.4, 0, 0], [0.15, -41.2, 0, 0],
             [0.20, -60.2, 0, 0], [0.25, -85.1, 0, 0], [0.30, -103.2, 0, 0], [0.35, -109.6, 0, 0],
             [0.40, -110.5, 0, 0], [0.45, -114.2, 0, 0], [0.50, -119.8, 0, 0], [0.55, -115.8, 0, 0],
             [0.60, -107.9, 0, 0], [0.65, -97.6, 0, 0], [0.70, -87.1, 0, 0], [0.75, -77.4, 0, 0],
             [0.80, -68.5, 0, 0], [0.85, -59.6, 0, 0], [0.90, -51.5, 0, 0], [0.95, -42.8, 0, 0],
             [1.00, -33.5, 0, 0]] },
    lowerLegR: { keys: [[0.00, 110, 0, 0], [0.05, 109.6, 0, 0], [0.10, 115.8, 0, 0], [0.15, 126, 0, 0],
             [0.20, 135.5, 0, 0], [0.25, 138.5, 0, 0], [0.30, 130.2, 0, 0], [0.35, 116.8, 0, 0],
