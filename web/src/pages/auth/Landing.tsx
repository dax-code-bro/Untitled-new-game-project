    ...
    <div className="auth-page">
      <div className="auth-card landing-card">
        ...
        <div className="auth-actions">
          ...
          <button className="auth-btn auth-btn-oauth" onClick={supabaseReady ? signInWithGoogle : () => navigate("/create-account")}>
          ...
          <button className="auth-btn auth-btn-oauth">
          ...
          <button className="auth-btn auth-btn-oauth">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor">
              <path d="M12.6 0H5.4A5.4 5.4 0 0 0 0 5.4v7.2A5.4 5.4 0 0 0 5.4 18h7.2a5.4 5.4 0 0 0 5.4-5.4V5.4A5.4 5.4 0 0 0 12.6 0zM9 13.5a4.5 4.5 0 1 1 0-9 4.5 4.5 0 0 1 0 9zm4.68-8.1a1.08 1.08 0 1 1 0-2.16 1.08 1.08 0 0 1 0 2.16z"/>
            </svg>
            Sign in with Apple
          </button>

          <button className="auth-btn auth-btn-oauth auth-btn-ai">
            <span className="ai-icon">⚡</span>
            Sign in with other AI
          </button>
        </div>
      </div>
    </div>
